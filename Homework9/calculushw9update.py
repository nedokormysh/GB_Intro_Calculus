# -*- coding: utf-8 -*-
"""CalculusHW9update.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1fHTfqEUXnUKLIifqgFWRiewU6Brh2ihG
...
Если я понимаю, то предел будет равен 1. А потому д'Аламбера не работает. По идее это не говорит нам о том, что монотонность не выполняется.
"""
